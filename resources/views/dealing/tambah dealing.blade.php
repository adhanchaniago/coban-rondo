...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Tambah Dealing <small></small></h1>
      <ol class="breadcrumb">
          ...
          <li class="active">Tambah Dealing</li>
        </ol>
    </section>
        ...
        <div class="col-xs-4">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Tambah Dealing</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->

            <form action="{{route('dealing.store')}}" method="post">
              {{ csrf_field() }}
              <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="tgl_LKO">
                  </div>
              </div>
              <!-- /.box-body -->
