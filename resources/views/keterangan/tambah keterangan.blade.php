...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Tambah Keterangan <small></small></h1>
      <ol class="breadcrumb">
              ...
              <div class="box-body">
                <div class="col-xs-12">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama_ket" placeholder="Masukkan Keterangan">
                  </div>
                  <div class="form-group">
                    <label for="quantity_ket">Quantity</label>
                    <input type="text" class="form-control" name="quantity_ket">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
